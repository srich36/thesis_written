...
\nomenclature{$n_{su,st\%}$}{Percent speed-up relative to C++ single threaded}
\nomenclature{$h$}{Integration step size }
\nomenclature{$\delta_{Jcrit}$}{The critical $\delta_{Javg}$ value for swarm stagnation}
\nomenclature{$P_{r,\text{\%}}$}{The percentage of the population reset upon swarm stagnation}
\nomenclature{$P_{num}$}{Number of particles in the swarm}
\nomenclature{$I_{num}$}{Number of algorithm Iterations}
\printnomenclature
